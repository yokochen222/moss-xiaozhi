...
InfraredDevice::InfraredDevice()
    : uart_num_(kUartPort), uart_listener_task_handle_(nullptr), uart_ok_(false) {
    InitializeUart();
...
void InfraredDevice::StartUartListenerTask() {
    ...
    BaseType_t xReturned = xTaskCreate(UartListenerTask, "UartListenerTask", 4096, this,
                                       tskIDLE_PRIORITY + 1, &uart_listener_task_handle_);
